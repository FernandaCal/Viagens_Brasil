...
<section>
    ...
    <h2>Política de Cookies Viagens Brasil</h2>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Viagens Brasil oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ul>
        ...
        <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Viagens Brasil, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ul>
